    ...
    <footer id="contact" className="border-t border-border bg-[#050505]">
      <Container className="section-pad !pb-8 !pt-14">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-text-secondary">
              Gym management software for owners who want members, attendance, payments and staff in
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-border pt-6 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm text-text-muted">Secure checkout via Razorpay</p>
